  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-row gap-6 max-w-6xl mx-auto overflow-x-auto pb-4 justify-start md:justify-center">
          {DATA.education.map((edu, index) => (
            <div
              key={index}
              className="bg-card-bg border border-card-border p-6 rounded-2xl hover:border-accent/50 transition-colors group flex-shrink-0 w-[240px] sm:w-[280px] md:w-[300px] h-[150px] sm:h-[160px] md:h-[180px] flex flex-col justify-between"
            >
